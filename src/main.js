...
app.innerHTML = `
  <main class="shell">
    <nav><div class="brand"><span class="mark">◈</span><span>Context Verifier</span></div><div class="nav-links"><button data-page="overview" class="active">How it works</button><button data-page="create">Create</button><button data-page="vote">Vote</button><button data-page="verify">Verify</button><button data-page="execute">Execute</button></div><button id="connect">Connect wallet</button></nav>
